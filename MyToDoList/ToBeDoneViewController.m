...
#import "ToBeDoneViewController.h"
#import "AppDelegate.h"
#import "ToDoItemDetailViewController.h"

@interface ToBeDoneViewController ()
...
@implementation ToBeDoneViewController
...
//        if ([[[self.toDo objectForKey:select] objectAtIndex:0] isEqualToString:@"NO"]) {
